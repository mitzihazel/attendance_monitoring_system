          ...
          <div id="page-wrapper">
              <div class="container-fluid content-wrapper">
                <div class="col-md-12">
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <form name="adduser" action="uploadimage.php" method="post" enctype="multipart/form-data">
                        <div class="well clearfix">
                          ...
                          <div class="col-md-3">
                            <div class="form-group">
                              ...
                              <input type="text" class="form-control" value="Faculty" name="usrlevel" readonly>
                            </div>
                          </div>
                           <div class="col-md-5">
                            <div class="form-group">
