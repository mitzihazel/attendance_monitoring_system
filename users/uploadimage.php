...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        $rfid = mysql_query("SELECT * FROM user_faculty");

        if(mysql_num_rows($rfid) == 0)
        {
            $birth = birthday($birthdate);

            $query_upload="INSERT into user_faculty(userID,lastName,firstName,mi,birthdate,age,status,gender,userType,rfidNo,image) VALUES ('".$_POST['userID']."','".$_POST['lastname']."','".$_POST['firstname']."','".$_POST['mi']."','".$_POST['birthdate']."', '".$birth."','".$_POST['status']."','".$_POST['gender']."','".$_POST['usrlevel']."','".$_POST['RFIDNo']."','".$target_file."')";
